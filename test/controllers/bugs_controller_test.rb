...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference("Bug.count") do
      post bugs_url, params: { bug: { description: @bug.description, name: @bug.name, project_id: @bug.project_id } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { description: @bug.description, name: @bug.name, project_id: @bug.project_id } }
